...
# @Function: Generate netlist using another I-V converter based on operational amplifier
#            by including module_header_B.sp
...
header_file = open("../../module_header_B.sp", "r")
...
# serve as a voltage subtractor and I-V converter B, combined in subtractorB

# first layer's voltage subtractor,dummy bitline on positive "+" terminal
for j in range(0, 100):
    output_file.write("xl1Subtractor%d wl2_%d wl2_%db v0 vb bl1_%d netvref subTractorB \n" % ((j+1), (j+1), (j+1), (j+1)))
...
# .subckt INVB out v0 vbl
for i in range(0, 3):
    output_file.write("xl2INVi%d out%d v0 bl2_%d INVB_2\n" % ((i+1), (i+1), (i+1)))
...
# .subckt INVB out v0 vbl
output_file.write("xrefi netvref v0 net137 INVB_1\n")
